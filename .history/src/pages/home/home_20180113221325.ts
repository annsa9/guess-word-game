...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public platform: Platform) {
    this.platform.ready().then(() => {
      ...
      this.randomLettersRemaining = this.pickRandomLetters(this.randomLettersRemaining, this.randomLettersLength-this.answerArray.length);
  ...
  pickRandomLetters(array, length): string[] {
