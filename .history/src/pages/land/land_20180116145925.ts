...
export class LandPage {
  ...
  loadSounds() {
    this.nativeAudio.preloadSimple('game_start', 'assets\sounds\start.ogg').then((onSuccess)=>{
      console.log('sound loaded', onSuccess);
    }, (onError)=>{
      console.log('sound not loaded', onError);
    });
  }
