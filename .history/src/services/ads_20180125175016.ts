...
export class Ads {
    ...
    bannerAdMobId: string = 'ca-app-pub-6426024580351118/6721742098';
    interstitialAdMobId: string = 'ca-app-pub-6426024580351118/2151941694';
    videoAdMobId: string = 'ca-app-pub-6426024580351118/2183731280';
