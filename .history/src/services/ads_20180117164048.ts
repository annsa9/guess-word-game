...
export class Ads {
    ...
    bannerAdMobId: string = 'ca-app-pub-3438993091130285/9589211492';
    interstitialAdMobId: string = 'ca-app-pub-3438993091130285/7822147338';
    videoAdMobId: string = 'ca-app-pub-3438993091130285/4851890138';
